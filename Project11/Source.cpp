...
void main()
{
	...
	cout << "Введите число(двоичная система?):";
	cin >> str;
	cout << "Ваше число:"<<str << endl;
    cout << str.is_bin() << endl;
	cout << "В десятичной системе:"<<str.bin_to_dec() << endl;
	cout << "Введите число(16-тиричная система?):";
	cin >> str;
	cout << "Ваше число:"<<str << endl;
	cout << str.is_hex() << endl;
	cout << "В десятичной системе:" << str.hex_to_dec() << endl;
